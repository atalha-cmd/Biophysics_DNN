...
# lists of output features / diagrams
new_set_features = []   # list of PImages
new_set_diagrams = []   # list of PD dicts
new_total_time = 0
counter = 0
...
# PImages
with open("TDA_test_PImage_features.pkl", "wb") as fp:   # Pickling
    pickle.dump(new_set_features, fp)

# Persistence Diagrams for each complex
